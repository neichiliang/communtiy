package life.myheart.community.interceptor;

import life.myheart.community.enums.AdPosEnum;
...
import life.myheart.community.service.AdService;
import life.myheart.community.service.NotificationService;
...
public class SessionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        //设置 context 级别的属性
        request.getServletContext().setAttribute("redirectUri", "url");
        // 没有登录的时候也可以查看导航
